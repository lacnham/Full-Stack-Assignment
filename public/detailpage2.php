<php>
    ...
    <body>
            ...
            <div class="header-container">
                <div class="navbar">
                    ...
                    <div class="search-box">
                        ...
                        <a href="Login_box.php"><i class="fas fa-sign-in-alt"></i></a> 
                    </div> 
                    <nav>
                        <div class="menu">
        ...
        <div class='smallcontainer detailproduct'>
            <div class='rowwf'>
                <div class="col2">
                    <img src="pics_nham/autumn2.jpg" alt='Autumn collection' width='400px;'>
                </div>
                <div class="col2">
                    <p>Home/ Jacket</p>
                    <h1>Brown Jacket</h1>
    ...
    <footer class="simple-footer">
        <div class="up-arrow">
            <a href="#navbar"><i class="fa fa-arrow-circle-up"></i></a>
            </div>
        <div class="container">
            <div class="content">
                <ul class="footer-nav">
